...
require_once ("phpClasses/Message.class.php"); //Damit ich auf die Klasse Picture zugreifen kann.
    ...
    <main class="s-main">
        ...
        <header class="s-header">
            <nav id="s-desktopMenu">
                ...
                <div class="s-headerLinkBox">
                    <div class="s-navItem"><a id="chosenMenuItem" href="#">Aktuelle Einträge</a></div>
        ...
        <nav id="s-mobileMenu">
            ...
            <div id="s-doubleMenuContainer">
                ...
                <ul>
                    <li><a id="chosenMenuItemMobileMenu" href="#" onclick="hideMobileMenu()">Aktuelle Einträge</a></li>
